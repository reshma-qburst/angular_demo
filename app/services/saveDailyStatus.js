...
app.service('saveStatus',function(){
	...
	return{
		saveActivity : function(date,project,activity,timeInMinutes,timeInSeconds,message){
			...
			historyArray.push({date : date.value,project : project,activity : activity,minute : timeInMinutes,seconds : timeInSeconds,message : message,today : dateToday,time : currentTime});
			return historyArray;
		}
	}
});